...
/* #if pdp11 | vax | tahoe | sun | accel | alliant */
#if '\377' < 0
#	define COFF 128
#else
#	define COFF 0
...
STATIC	char	ifelstk[MAX_DEPTH];
	...
	* command line.
	*/
#define MAX_PD_MACH	12	/* set so it is where PD_MY_MACH is at */
#define D_interdata	0	/* define table indexes */
#define D_pdp11		1
#define D_vax		2
#define D_u370		3
#define D_u3b		4
