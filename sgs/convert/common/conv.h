...
#define FLG32WR "vax"
#define FLG16WR "pdp"
#define IS32W(x)	(equal(x,FLG32W1,3)||equal(x,FLG32W2,3)||equal(x,FLG32W3,3)||equal(x,FLG32W4,4)||equal(x,FLG32W5,5)||equal(x,FLG32W6,3))
...
#define ANYMAGIC(x)	(IS3B(x)||ISM32(x)||ISB16(x)||ISX86(x)||ISVAX(x)||ISMC68(x))
